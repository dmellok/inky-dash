// QR Code generator library — Project Nayuki, MIT licensed.
// Source: https://www.nayuki.io/page/qr-code-generator-library
// Compiled from typescript-javascript/qrcodegen.ts via esbuild
// (strip types, emit ES2022). The IIFE pattern below pre-dates ES
// modules; the `export { qrcodegen }` at the bottom makes the
// namespace accessible to plugin client.js as an ES module import.
var qrcodegen;
((qrcodegen2) => {
  class QrCode {
